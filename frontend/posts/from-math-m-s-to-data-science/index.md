---
title: "From Math M.S. to Data Science"
slug: from-math-m-s-to-data-science
status: published
featured: false
date: 2019-08-28T16:27:00.000-07:00
tags:
  - "Blog"
  - "Learning in Public"
...
I wasn’t convinced at the time, but after deciding that spending another five to six years as a student wasn’t the right decision for my career trajectory for now, I finally took her advice. Following the guidance of Edouard Harris, co-founder of [Sharpest Minds](https://www.sharpestminds.com/), I started by learning Python (beginning with José Portilla’s [Complete Python Bootcamp](https://www.udemy.com/complete-python-bootcamp/), and then filling in a few gaps in my foundation with Jake VanderPlas’ [Whirlwind Tour of Python](https://github.com/jakevdp/WhirlwindTourOfPython)). By no means would I claim to have mastered Python at this time, but I have enough of the basics down to take the next step.
...
A funny thing happened on the way to becoming a data scientist: [I became a technical writer instead!](https://www.blog.lauralangdon.io/how-i-became-a-technical-writer) But I get messages somewhat regularly by readers of this post, usually along one of these two lines of inquiry:
...
*   some SQL (databases are _everywhere_)

And while you're learning these universal skills, [find social media accounts belonging to people in several different areas of tech](https://www.blog.lauralangdon.io/how-to-use-social-media-in-your-job-hunt), even if you just read. You'll start to get a bit of a feel for how different industries function, and if you follow who those people follow, you'll get a much bigger picture of the landscape.
...
*   the ability to write [production-level Python](https://towardsdatascience.com/how-to-write-a-production-level-code-in-data-science-5d87bd75ced)
...
I've made a [list of my favorite resources for learning many of these skills](https://www.blog.lauralangdon.io/some-of-my-favorite-tech-resources). I hope this was helpful! Thanks for reading. 😊
